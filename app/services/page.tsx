...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/" className="text-gray-600 hover:text-[#002F6C] font-medium transition-colors duration-200">
                Home
              </Link>
              <Link href="/services" className="text-[#002F6C] font-semibold border-b-2 border-[#002F6C] pb-1 transition-colors">
                Services
              </Link>
              <Link href="/civic-voice" className="text-gray-600 hover:text-[#002F6C] font-medium transition-colors duration-200">
                Civic Voice
              </Link>
              <Link href="/know" className="text-gray-600 hover:text-[#002F6C] font-medium transition-colors duration-200">
                Know Lesotho
              </Link>
              <Link href="/museum" className="text-gray-600 hover:text-[#002F6C] font-medium transition-colors duration-200">
                Museums
              </Link>
        ...
        <div className="relative container mx-auto px-4 lg:px-8 py-16 lg:py-24">
          ...
          <div className="text-center text-white animate-fade-in-up">
            ...
            <p className="text-xl lg:text-2xl text-blue-100 mb-12 max-w-4xl mx-auto font-light leading-relaxed">
              Find and apply for all government services online. Fast, secure, and available 24/7.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50/50">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#002F6C] mb-4">Find Your Service</h2>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="w-full">
              <div className="flex flex-wrap gap-2 md:gap-3 justify-center lg:justify-start">
                {categories.map((category, index) => (
                  ...
                  >
                    ...
                    {selectedCategory === category.id && (
                      <div className="absolute inset-0 bg-white/10 rounded-xl active-filter-indicator" />
                    )}
                    
                    {/* Category icon for visual appeal */}
                    <div className={`
                    ...
                    <div className={`
                      ...
                      ${
                        selectedCategory === category.id
                          ? 'bg-white/5'
                          : 'bg-gradient-to-r from-[#007849]/8 to-[#002F6C]/8'
                      }
                    `} />
                  </button>
                ))}
              ...
              {/* Results summary with smooth transition */}
      ...
      <div className="container mx-auto px-4 py-8">{/* Services Results */}
            ...
            <Link key={service.id} href={`/services/${service.id}`} className="group">
              <Card className="h-full hover-lift card-shadow border-0 bg-gradient-to-br from-white to-gray-50/50 overflow-hidden group-hover:from-white group-hover:to-blue-50/30 transition-all duration-300">
                ...
                <CardContent className="pt-0">
                  ...
                  <Button className="w-full bg-[#007849] hover:bg-[#005a37] text-white font-semibold py-3 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-200">
                    Apply Now
