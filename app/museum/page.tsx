      ...
      <div className="bg-gradient-to-br from-[#002F6C] via-[#003d7a] to-[#007849] text-white py-16">
        ...
        <div className="relative container mx-auto px-4 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold mb-6">Digital Museum of Lesotho</h1>
              <p className="text-xl lg:text-2xl text-blue-100 font-light leading-relaxed">Explore the rich heritage and culture of the Kingdom of Lesotho</p>
            </div>
