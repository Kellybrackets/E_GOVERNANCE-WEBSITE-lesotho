...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    console.log("🔍 Login attempt started", { identifier: formData.identifier, returnUrl })
    setIsLoading(true)
    ...
    try {
      ...
      console.log("💾 Setting authentication in localStorage...")
      
      // Set authentication in localStorage with error handling
      try {
