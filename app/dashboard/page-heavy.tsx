...
function DashboardPage() {
  ...
  const getRelatedServices = (docType: string) => {
    const services: Record<string, Array<{ name: string; href: string }>> = {
      "national-id": [
          ...
          <Card className="dashboard-stat-card hover-lift">
            <CardContent className="p-4">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-lg md:text-2xl font-bold text-gray-900">{notifications.filter((n) => !n.read).length}</p>
                              ...
                              <Dialog>
                                ...
                                <DialogContent>
                                  ...
                                  <div className="space-y-3">
                                    {getRelatedServices(doc.type).map((service: any, index: any) => (
                                      <Button
                                        key={index}
                                        variant="outline"
      ...
      <div className="space-y-6 md:space-y-8">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg md:text-xl font-semibold text-gray-900">Application Progress</h2>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg md:text-xl font-semibold text-gray-900">Recent Notifications</h2>
